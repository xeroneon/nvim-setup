...
vim.keymap.set('n', '<leader>w', ':w<CR>', {
  desc = '[w] Write the current buffer',
  silent = true,
})
vim.keymap.set('n', '<leader>q', ':q<CR>', {
  desc = '[q] Quit the current buffer',
  silent = true,
})
...
vim.keymap.set('n', '<leader>o', '<cmd>Neotree float<CR>', {
  noremap = true,
  silent = true,
})
...
vim.keymap.set('n', '<leader>bC', '<cmd>bd!<CR>', {
  desc = 'Close current buffer without saving',
  noremap = true,
  silent = true,
})
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>ld', vim.lsp.buf.type_definition, '[L]SP [D]efinition')
